			...
			<a href="#" class="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded">
				<svg
					...
					><path
						...
						stroke-linejoin="round"
						stroke-width="2"
						d="M5.121 12.121a3 3 0 114.242-4.242 3 3 0 014.242 0 3 3 0 014.242 4.242 3 3 0 010 4.242 3 3 0 01-4.242 0 3 3 0 01-4.242 0 3 3 0 01-4.242 0z"
					/></svg
				>
				<span>Profile</span>
			</a>
			<a href="#" class="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded">
				<svg
					...
					><path
						...
						stroke-linejoin="round"
						stroke-width="2"
						d="M12 8v4m0 4h.01m-6.938 4h13.856a2 2 0 001.992-1.803l.78-7.02a2 2 0 00-1.995-2.197H3.272a2 2 0 00-1.995 2.197l.78 7.02A2 2 0 003.874 20z"
					/></svg
				>
				<span>Settings</span>
			</a>
			<a href="#" class="flex items-center space-x-2 hover:bg-gray-700 p-2 rounded">
				<svg
					...
					><path
						...
						stroke-linejoin="round"
						stroke-width="2"
						d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H7a3 3 0 01-3-3v-1m6-10V4a3 3 0 013-3h4a3 3 0 013 3v1"
					/></svg
				>
				<span>Logout</span>
			</a>
